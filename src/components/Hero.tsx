      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          <motion.h1
            ...
            className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight text-slate-900 dark:text-white max-w-4xl leading-[1.15] sm:leading-[1.1] mb-4 sm:mb-6"
          >
            Find your people.{" "}
          ...
          <motion.p
            ...
            className="text-sm sm:text-lg md:text-xl text-slate-700 dark:text-slate-300 max-w-2xl font-normal leading-relaxed mb-8 sm:mb-10 px-2"
          >
