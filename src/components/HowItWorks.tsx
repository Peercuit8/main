    ...
    <section id="how-it-works" className="py-24 relative overflow-hidden">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          ...
          {STEPS.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="glass-card rounded-3xl p-6 sm:p-7 flex flex-col justify-between border border-emerald-300/60 dark:border-emerald-500/25 shadow-xl relative hover:border-emerald-400 dark:hover:border-emerald-500/60 transition-all hover:scale-[1.02]"
              >
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <span className="text-3xl font-black text-slate-300 dark:text-emerald-800 font-mono">
                      {item.step}
                    </span>
                ...
                {/* Micro Mockup */}
                <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-[#07130c]/90 border border-slate-200 dark:border-emerald-500/15 text-xs text-slate-700 dark:text-slate-300 space-y-1.5">
                  ...
                  {item.mock.channels?.map((ch, i) => (
                    <span
                      key={i}
                      className="inline-block mr-1 text-[10px] bg-white dark:bg-[#0c1a11] px-1.5 py-0.5 rounded border border-slate-200 dark:border-emerald-500/20 font-mono text-emerald-800 dark:text-emerald-300"
                    >
                      {ch}
                    </span>
                  ))}
        ...
        <div className="mt-12 text-center">
          <Link
            href="/apply"
            className="inline-flex items-center gap-2 px-8 py-4 text-base font-bold text-white bg-[#0d623d] hover:bg-[#094d2f] dark:bg-emerald-600 dark:hover:bg-emerald-500 rounded-xl shadow-lg shadow-emerald-900/15 dark:shadow-emerald-600/30 transition-all hover:scale-[1.02] active:scale-[0.98]"
          >
